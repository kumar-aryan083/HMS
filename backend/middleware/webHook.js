...
function replaceUrlsInText(text) {
    if (typeof text !== 'string') {
        return text || ''; // Return the text as is or an empty string if null/undefined.
    }
...
export async function slackLogger(title, descriptionParam, error, req, hook = webhookURL) {
    const blocks = [];
    blocks.push({
        block_id: 'title',
        type: 'section',
