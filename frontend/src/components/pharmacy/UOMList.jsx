...
const UOMList = ({ admissionId }) => {
  ...
  const fetchSuppliers = async () => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/get-uoms?page=${currentPage}&limit=${itemsPerPage}`,
        {
          method: "GET",
          headers: {
  ...
  const handleDeleteSuppliers = async (medicineId) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/delete-uom/${medicineId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleUpdateSuppliers = async (updatedData) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/edit-uom/${updatedData._id}`,
        {
          method: "PUT",
          headers: {
            "x-tenant-id": environment.tenantId,
