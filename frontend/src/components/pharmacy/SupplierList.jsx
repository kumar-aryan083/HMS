...
const SupplierList = ({ admissionId }) => {
  ...
  const fetchSuppliers = async () => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/get-suppliers?page=${currentPage}&limit=${itemsPerPage}`,
        {
          method: "GET",
          headers: {
  ...
  const handleDeleteSuppliers = async (medicineId) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/delete-supplier/${medicineId}`,
        {
          method: "DELETE",
          headers: {
  ...
  const handleUpdateSuppliers = async (updatedData) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/edit-supplier/${updatedData._id}`,
        {
          method: "PUT",
          headers: {
            "x-tenant-id": environment.tenantId,
  ...
  return (
    <div className="pharmacy-list">
      <h2 className="pharmacy-heading">Suppliers</h2>
