...
const ItemTypeList = ({ admissionId }) => {
  ...
  const fetchSuppliers = async () => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/get-item-types?page=${currentPage}&limit=${itemsPerPage}`,
        {
          method: "GET",
          headers: {
  ...
  const handleDeleteSuppliers = async (medicineId) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/delete-item-type/${medicineId}`,
        {
          method: "DELETE",
          headers: {
            "x-tenant-id": environment.tenantId,
  ...
  const handleUpdateSuppliers = async (updatedData) => {
    ...
    try {
      const res = await fetch(
        `${environment.url}/api/pharmacy/edit-item-type/${updatedData._id}`,
        {
          method: "PUT",
          headers: {
            "x-tenant-id": environment.tenantId,
