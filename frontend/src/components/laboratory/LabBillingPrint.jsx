...
const LabBillingPrint = ({ printRef, patientDetails, selectedBill }) => {
  ...
  return (
    <div className="ipd-bill-layout print-content print-only" ref={printRef}>
      ...
      <div className="top-border">
        <div className="patient-details-container">
          {[
            ...
            {
              label: "Prescribed By",
              value: selectedBill?.prescribedByName?.toUpperCase() || "N/A",
            },
          ]
      ...
      >
        {/* <div className="pharmacy-bill-terms-condition">
          <div>
            <h4
              style={{
                marign: "0",
            ...
            <p style={{ color: "black", textAlign: "left" }}>
              Goods once sold will not be taking back or exchanged.
            </p>
            <p style={{ color: "black", textAlign: "left" }}>
              Bills not paid before due date will attract 24% interest.
            </p>
            <p style={{ color: "black", textAlign: "left" }}>
            ...
            <p style={{ fontWeight: "500", color: "black", textAlign: "left" }}>
              Remark:{" "}
            </p>
          </div>
        </div> */}
...
export default LabBillingPrint;
