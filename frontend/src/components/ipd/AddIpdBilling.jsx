...
import "./styles/AddIpdBilling.css";
import { environment } from "../../../utlis/environment";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faTrashAlt } from "@fortawesome/free-solid-svg-icons";
import SearchableDropdown from "./SearchableDropdown";

const AddIpdBilling = ({ isOpen, onClose, onAddBilling, admissionId }) => {
  ...
  //     } else if (itemType) {
  //       // const response = await fetch(
  //       //   `${environment.url}/api/ipd/get-all-ipds-items`,
  //       //   // `${environment.url}/api/ipd/get-ipd-items?itemType=${itemType}&patientAddmissionId=${admissionId}`,
  //       //   {
  //       //     headers: {
  //       //       token: localStorage.getItem("token"),
  //       //       "ngrok-skip-browser-warning": "true",
